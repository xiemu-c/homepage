    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://p.xiemu.top/img/avatar.jpg"
              alt="developer-image"
              width="250"
              height="250"
              quality="95"
      ...
      <motion.div
        className="flex flex-row flex-wrap items-center justify-center gap-3 px-4 text-lg font-medium"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          delay: 0.1,
